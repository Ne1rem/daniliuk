  ...
  return (
    <section id="projects">
      <div className="flex flex-col gap-2 mb-[80px] max-w-[600px] max-sm:mb-[64px] max-sm:gap-3">
        <h2 className="font-normal text-[76px] leading-[100%] max-sm:text-[43px]">
          My projects
        </h2>
          ...
          >
            ...
            <div className="flex flex-col justify-center 2xl:max-w-[1100px] xl:max-w-[800px] md:max-w-[600px] sm:max-w-[400px]">
              ...
              <div className="flex flex-col mb-[48px] max-sm:mb-[40px]">
                ...
                <ul>
                  {Object.entries(project.projectsInfo).map(([key, value]) => (
                    <li key={key}>
                      <p className="flex flex-row justify-between font-manrope text-[16px] font-medium leading-[160%] text-primary-color items-center py-4">
